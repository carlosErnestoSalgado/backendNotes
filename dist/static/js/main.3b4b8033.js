...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__platform_index_js__ = __webpack_require__(3);
...
const defaults = {
  ...
  adapter: __WEBPACK_IMPORTED_MODULE_5__platform_index_js__["a" /* default */].isNode ? 'http' : 'xhr',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom_client__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__platform_index_js__ = __webpack_require__(3);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_js__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__platform_index_js__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__platform_index_js__ = __webpack_require__(3);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Note__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_noteServices__ = __webpack_require__(51);
...
var App = function App() {
  ...
  __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react__["useEffect"])(function () {
    __WEBPACK_IMPORTED_MODULE_2__services_noteServices__["a" /* default */].getAll().then(function (initialNotes) {
  ...
  var addNote = function addNote(event) {
    ...
    __WEBPACK_IMPORTED_MODULE_2__services_noteServices__["a" /* default */].create(noteObject).then(function (newNote) {
  ...
  var toggleImportant = function toggleImportant(id) {
    console.log("La nota " + id + "quiere cambiar su importancia");

    //const url = `http://localhost:3001/api/notes/${id}`; // Creamos la url dinamicamente
    var note = notes.find(function (note) {
      return note.id === id;
    }); // buscamos la nota con esa url
    var changedNote = Object.assign({}, note, { important: !note.important }); // Cambiamos solo la propiedad important de esa nota

    __WEBPACK_IMPORTED_MODULE_2__services_noteServices__["a" /* default */].update(note.id, changedNote).then(function (change) {
      setNotes(notes.map(function (note) {
        return note.id !== id ? note : change;
      }));
      // esta lina anterior lo que hace es agreagar a setNotes una nueva matriz que contendra todas las notas tal cual
      // excepto la nota cambiada, la cual mostarra la devuelta por el servidor
      console.log(change);
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'ul',
        null,
        notesToShow.map(function (note, index) {
          return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__components_Note__["a" /* default */], { key: index, note: note, toggleImportance: function toggleImportance() {
              return toggleImportant(note.id);
            } });
        })
      )
    ),
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'form',
      { onSubmit: addNote },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('input', { value: newNote, onChange: handleNoteChange }),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'button',
        { type: 'submit' },
        'save'
...
var getAll = function getAll() {
  var request = __WEBPACK_IMPORTED_MODULE_0_axios__["a" /* default */].get(baseUrl);
  // const nonExisting = {
  //   id: 10000,
...
var create = function create(newObject) {
  var request = __WEBPACK_IMPORTED_MODULE_0_axios__["a" /* default */].post(baseUrl, newObject);
  return request.then(function (response) {
    return response.data;
  });
};
...
var update = function update(id, newObject) {
  var request = __WEBPACK_IMPORTED_MODULE_0_axios__["a" /* default */].put(baseUrl + '/' + id, newObject);
  return request.then(function (response) {
    return response.data;
  });
};
...
*/
var aa=__webpack_require__(4),ca=__webpack_require__(65);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.3b4b8033.js.map